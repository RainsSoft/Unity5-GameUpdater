 ...
 class Demo : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        StartCoroutine( updater.DoUpdate("publish/vc", "http://127.0.0.1/AssetBundles/StandaloneWindows/publish/vc","http://127.0.0.1/AssetBundles/StandaloneWindows/publish/", "password"));
    ...
    void LoadAssets()
    {
        ...
        //
       Instantiate(updater.LoadAssetBundle("button_1").LoadAsset("Sphere"));
       Instantiate(updater.LoadAssetBundle("gameobject1").LoadAsset("Sphere"));
